...
The profiles table does not shrink inside the page's flex layout, so a long list remains part of the page's vertical scroll area instead of clipping its final rows.
